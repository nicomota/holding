...
const store = new Vuex.Store({
  state: {
    // initial state
    servers: [
    { name: 'Itau', status: true, adr: '192.168.0.24' },
    { name: 'BMG', status: true, adr: '192.168.0.25', type: 'database' },
    { name: 'Bradesco', status: true, adr: '192.168.0.26', type: 'database' },
    { name: 'C6', status: true, adr: '192.168.0.37' },
    { name: 'Neon', status: true, adr: '192.168.0.17' },
    { name: 'Banrisul', status: true, adr: '192.168.0.23' },
    { name: 'Daycoval', status: true, adr: '192.168.0.47' },
    { name: 'Facta', status: true, adr: '192.168.0.47' },
    { name: 'Mercantil', status: true, adr: '192.168.0.47' },
    { name: 'Ole', status: true, adr: '192.168.0.47' },
    { name: 'Pan', status: true, adr: '192.168.0.127' }] },
